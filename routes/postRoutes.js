...
router.post("/createPost", authenticateToken, upload.single('postImage'), postController.createPost);


// get all posts for a user's feed for infinite scroll pagination. Latests post are shown everytime.
router.get("/", authenticateToken, postController.getAllPosts);

router.get("/fromFollowing", authenticateToken, postController.getAllPostsFromFollowing);
...
router.post("/:postId/removeReaction/:reaction", authenticateToken, postController.removeReaction);

// get posts of a username
router.get("/user/:username", authenticateToken, postController.getPostsFromUsername);
