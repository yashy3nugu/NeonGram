...
const FollowButton = ({auth,user,followUser,selectUser}) => {
    ...
    return <button onClick={(e) => {
        followUser(user._id);
        e.preventDefault()
        }} className="bg-neon-purple px-3 py-3 rounded-full text-white hover:bg-purple-900 hover:text-gray-400 transition ease-in-out duration-200"><UserAddIconSolid className="w-6"/></button>
