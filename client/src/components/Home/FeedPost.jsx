    ...
    <div className="post w-10/12 sm:w-1/2 rounded-xl mx-auto  bg-gray-900 my-20 px-3 border-2 border-neon-purple">
        ...
        <div>
          ...
          {post.user.profilePicture ? (
            <a href={`/user/${post.user.username}`} className="mr-4">
              <img
                className="w-8 inline rounded-full"
          ...
          <a href={`/user/${post.user.username}`} className="text-white">
            {post.user.username}
          </a>
        </div>
        <div>
      ...
      <div className="flex justify-between align-middle mt-2 mb-3">
        <div className="flex">
          <button
            onClick={handleLiked}
            className="mx-2 outline-none w-8 text-neon-blue"
          >
            {liked ? (
              <ThumbUpIconFilled className="thumb-up" />
            ) : (
          ...
          <button
            ...
            className="mx-2 outline-none w-8 text-neon-red relative top-0.5"
          >
            {disliked ? (
              <ThumbDownIconFilled className="thumb-down" />
            ) : (
